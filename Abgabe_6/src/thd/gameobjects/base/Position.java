...
public class Position {
     ...
     *
     * @param other Another position.
     * @return the distance of the objects using Pythagoras.
     */
    ...
    public boolean equals(Object other) {
        ...
        Position castedOther = (Position) other;
        return Double.compare(x, castedOther.x) == 0
                && Double.compare(y, castedOther.y) == 0;
    }
